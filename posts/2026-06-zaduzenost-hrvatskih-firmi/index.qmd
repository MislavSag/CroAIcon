...
subtitle: "Tipična RH firma duguje 6,6% prihoda. Sve firme zajedno 32%. Kad dug prijeđe godišnji prihod, ulaganje se stisne prema nuli"
description: ""
...
Koliko su hrvatske firme zadužene? Probajmo odgovoriti pomoću dvije brojke. (Naslov obećava pedeset, ali dovoljne su zapravo dvije.) Tipična firma duguje malo. **6,6% prihoda (2024.)**. Sve firme zajedno, puno. **32%**.

Ta razlika otvara priču. Dug nije masovan, nego koncentriran. I to u nekoliko dimenzija. Veličina firme, profitabilnost, sektor, ročnost i ulaganje. Zadnja dimenzija je najvažnija. Dug je problem tek kad počne jesti prostor za novi projekt.
...
## Nekretnine su najteži omjer, ali stanje duga je šire
...
To je mjera tereta, ne mjera ukupnog stanja duga. Nekretnine prirodno nose više imovine i duga prema prihodu. Ali kad se gleda gdje sjedi ukupan identificirani financijski dug, slika se širi.

![Udio ukupnog financijskog duga po sektoru, dugoročni i kratkoročni dio.](debt_5_sector_stock.png)

Građevinarstvo nosi **19%** ukupnog financijskog duga, prerađivačka industrija **15%**, trgovina **13%**, nekretnine **11%**, a smještaj i ugostiteljstvo **10%**. Omjer ranjivosti vrišti iz nekretnina, ali stanje duga sjedi u široj kapitalnoj jezgri ekonomije.
...
## Ulaganje se stanji kad dug prijeđe godišnji prihod

![Neto promjena dugotrajne imovine po razredu lagirane zaduženosti.](debt_6_investment_bins.png)

Četvrta dimenzija je ulaganje. Ovdje koristimo promjenu dugotrajne imovine kroz firmu, podijeljenu dugotrajnom imovinom iz prethodne godine. To nije savršen capex, ali je dobar prvi trag.
...
To nije kauzalni test. Visok dug može značiti da je investicijski ciklus već odrađen. Može značiti i da firma nema prostor za novi projekt. Ali kao dijagnostika financijske frikcije nalaz je jasan. Umjeren dug prati ulaganje. Težak dug ga ne prati.

## Dug najviše boli kad nema marže

![Neto promjena dugotrajne imovine po dugu i profitabilnosti.](debt_7_debt_overhang.png)

Aktualni literaturni kut nije samo *koliko duga*. Nego *koji dug, kod koje firme, uz koju zaradu*. To je debt-overhang logika. Dug postaje frikcija kad kreditori imaju prvi red na budućem novcu, a firma nema dovoljno marže da istodobno nosi dug i novi projekt.

GFI pokazuje isti oblik. Kod firmi s jakom maržom investicijski trag ostaje pozitivan u svim razredima duga. Čak i iznad godišnjeg prihoda iznosi **2,2%**. Kod firmi sa slabom maržom slika puca. U razredu **50% do 100%** duga/prihoda ulaganje je **minus 0,7%**, a iznad **100%** je **minus 0,2%**.

Zaključno. Dug nije loš sam po sebi. Financira imovinu, hotele, strojeve, skladišta i projekte. Problem počinje kad se dug spoji sa slabom maržom i kratkim rokom. Tu se vidi prava financijska frikcija. Ne u prosječnoj firmi, nego u dijelu bilanci gdje obveza već jede prostor za novo ulaganje.
